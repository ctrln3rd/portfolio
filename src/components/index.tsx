  ...
  return (
      <>
       ...
       <div className="absolute inset-1/2 -translate-x-1/2 -translate-y-1/2 w-full h-full flex items-center justify-center z-0">
        ...
        <h2 className="text-xl uppercase">FU<GlitchText text='TUR' effect='continuous' stopDuration={3}/>ISTIC & MINIMALIST <br/> <GlitchText text='WE' effect='continuous' stopDuration={3}/>B APPS</h2>
        <p className="opacity-70">Web apps, computers, softwares, business</p>
        </div>
        <div className='fixed flex flex-col items-start gap-2 z-50 bottom-0 left-0 pl-20 pb-8 text-base max-sm:pl-3'>
          <h3>Hello Buddy....<br/> I'm <span className='text-teal-600'><GlitchText text='Austine' effect='one-time'/> Mark</span></h3>
